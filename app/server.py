...
def root():
    ...
    datasets_string = request.args.get('datasets', '')
    if datasets_string:
    ...
    # slope thresholds
    slope_threshold = request.args.get('slope_threshold', '')
    if slope_threshold:
        template_values['slope_threshold'] = float(slope_threshold)
    else:
        template_values['slope_threshold'] = '0.03'

    slope_threshold_sensitive = request.args.get('slope_threshold_sensitive', '')
    ...
    max_doy = request.args.get('max_doy', '')
    if min_doy:
